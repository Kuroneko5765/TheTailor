...
namespace TheTailor.Cards.Rare
{
    ...
    public class JacketPocket() : CustomCardModel(1, CardType.Skill, CardRarity.Rare, TargetType.Self)
    {
        ...
        protected override IEnumerable<IHoverTip> ExtraHoverTips => [HoverTipFactory.FromCard<Cards.Token.Patch>(), HoverTipFactory.FromKeyword(TheTailor.Keywords.Delicate)];
