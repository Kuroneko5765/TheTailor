...
namespace TheTailor.Cards.Common
{
    ...
    public class Slippers() : CustomCardModel(1, CardType.Skill, CardRarity.Common, TargetType.Self), IOnStitchEffect
    {
        ...
        protected override IEnumerable<DynamicVar> CanonicalVars => [new CardsVar(1), new BlockVar(5m ,ValueProp.Move), new DynamicVar("ReplayPluralize", 1), new DynamicVar("Replay", 1)];
