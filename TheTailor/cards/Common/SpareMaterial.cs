...
namespace TheTailor.Cards.Common
{
    ...
    public class SpareMaterial() : CustomCardModel(0, CardType.Skill, CardRarity.Common, TargetType.Self)
    {
        ...
        protected override IEnumerable<IHoverTip> ExtraHoverTips => [HoverTipFactory.FromKeyword(TheTailor.Keywords.LeatherMinion), IsUpgraded ? HoverTipFactory.FromKeyword(TheTailor.Keywords.Delicate) : HoverTipFactory.FromKeyword(CardKeyword.Exhaust), HoverTipFactory.FromKeyword(CardKeyword.Exhaust)];
