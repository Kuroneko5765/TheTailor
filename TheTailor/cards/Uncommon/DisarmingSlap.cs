...
namespace TheTailor.Cards.Uncommon
{
    ...
    public class DisarmingSlap() : CustomCardModel(1, CardType.Attack, CardRarity.Uncommon, TargetType.AnyEnemy)
    {
        ...
        protected override IEnumerable<DynamicVar> CanonicalVars => [new DamageVar(9m, ValueProp.Move), new DynamicVar("StrengthDown", 8), new DynamicVar("Delicate", 2)];
